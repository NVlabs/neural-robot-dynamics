...
```bash
python run_rl.py --rl-cfg ./cfg/Anymal/anymal_two_robot_interaction.yaml --playback ../../pretrained_models/RL_policies/Anymal/forward_walk/0/nn/AnymalPPO.pth --render
```
